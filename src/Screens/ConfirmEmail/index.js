...
export default function ConfirmEmail() {
  ...
  return (
    <Box style={styleConfirmEmail.containerP}>
      <Box style={styleConfirmEmail.containerSecundario}>
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          <Box style={styleConfirmEmail.containerTitle}>
            ...
            <Text style={styleConfirmEmail.titleTwo}>
              Precisamos saber qual e-mail está utilizando, vamos envia-lo um
              código pra você!
            </Text>
          </Box>
          <Box style={styleConfirmEmail.container}>
            ...
            >
              {({ handleChange, setFieldTouched, isValid, values }) => (
                <FormControl
                  isInvalid={!isValid}
                  style={styleConfirmEmail.formControl}
                >
                  <FormControl.Label>
                    <Text style={styleConfirmEmail.labelInput}>
                      Email or Nickname
                    </Text>
                  </FormControl.Label>
                  <Input
          ...
          <Box style={styleConfirmEmail.boxBotton}>
            <Button
              onPress={() => submitCode()}
